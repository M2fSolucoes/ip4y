            ...
            <div style="display: table; width: 100%; height: 100%;">
              <div class="u-col u-col-100" style="min-width: 600px;">
                <div style="height: 100%; width: 100%; background-color: #ffffff; padding: 30px 20px 10px;">
                  <h1 style="font-family: Arvo, serif; font-size: 30px; line-height: 120%;">Olá, a tarefa {{$task->title}}, foi atualizada!</h1>
                  <div style="font-family: Raleway, sans-serif; font-size: 14px; color: #7e8c8d; line-height: 140%;">
                    Olá, <b>{{$user->first()->name}}</b> , a tarefa  <b>{{$task->title}}</b> designada a você sofreu ateração de status e agora encontra-se <b>{{$task->status}}</b> , qualquer dúvida entre en contato com seiu lider!</p>
                    <ul>
                      <li>Projeto: <b>{{$project->first()->title}} | {{$project->first()->project_code}}</b> </li>
